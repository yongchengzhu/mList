...
const StatusSelector: FC<{}> = () => {
  ...
  const { sortFilterConfig } = useSelector((state: RootState) => state.book);
          ...
          <div className={styles.logoContainer}>
            <img
              ...
              onClick={() => {
                ...
                dispatch(
                  setSortConfigAction({ key: 'daysToWait', order: 'asc' })
                );
              }}
              src={logo}
              alt="Logo"
        ...
        <div className={styles['status-selector']}>
          <span>
            <input
              ...
              checked={filterConfig.status === 'reading'}
            />
          ...
          <span>
            <input
              ...
              value="dropped"
              onChange={handleStatusFilterChange}
              checked={filterConfig.status === 'dropped'}
            />
          ...
          <span>
            <input
              ...
              value="axed"
              onChange={handleStatusFilterChange}
              checked={filterConfig.status === 'axed'}
            />
            <label htmlFor="axed">
          ...
          <span>
            <input
              ...
              value="planned"
              onChange={handleStatusFilterChange}
              checked={filterConfig.status === 'planned'}
            />
          ...
          <span>
            <input
              ...
              value="completed"
              onChange={handleStatusFilterChange}
              checked={filterConfig.status === 'completed'}
            />
